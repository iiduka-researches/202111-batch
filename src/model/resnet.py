...
def conv3x3(in_channels: int or tuple, out_channels: int or tuple,
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels: int or tuple, out_channels: int or tuple, stride: int = 1,
                 downsample: torch.nn.Module = None, groups: int = 1, base_width: int = 32, dilation: int = 1,
...
class ResNetCIFAR(nn.Module):
    ...
    def __init__(self, block: nn.Module, layers: list, num_classes: int = 10, zero_init_residual: bool = False,
                 groups=1, width_per_group=32, replace_stride_with_dilation: list = None,
                 norm_layer: nn.Module = None):
        """
        Parameters
        ----------
